...
class Article {
    ...
    static async enterArticleEditMode(parent_container, data_model) {
        ...
        for (let i = 0; i < data_model.webpage.articles.length; i++) {
            if (data_model.webpage.articles[i].article_id === article_id) {
                index = i;
            }
        }
        ...
        // Edit Links
        Article.makeLinksEditable(data_model, parent_container, index);
    ...
    static async makeLinksEditable(data_model, parent_container, index) {
        ...
        for (let i = 0; i < text_containers.length; i++) {
            Article.makeLinkEditable(data_model, text_containers[i], index, i);
        }
    }
    ...
    renderArticle(article_data) {
        switch(article_data.template) {
            case "template-1":
                return this.renderArticleTemplateOne(article_data.article_id, article_data.template, article_data.heading, article_data.texts, article_data.links);
            case "template-2":
                return this.renderArticleTemplateTwo(article_data.article_id, article_data.template, article_data.heading, article_data.texts, article_data.links, article_data.images);
            case "template-3":
                return this.renderArticleTemplateThree(article_data.article_id, article_data.template, article_data.heading, article_data.texts, article_data.links, article_data.images);
            case "template-4":
                return this.renderArticleTemplateFour(article_data.article_id, article_data.template, article_data.heading, article_data.subheadings, article_data.texts, article_data.links, article_data.images);
            case "template-5":
                return this.renderArticleTemplateFive(article_data.article_id, article_data.template, article_data.heading, article_data.subheadings, article_data.texts, article_data.links, article_data.images);
            case "template-6":
                return this.renderArticleTemplateSix(article_data.article_id, article_data.template, article_data.heading, article_data.subheadings, article_data.texts, article_data.links, article_data.images);
            case "template-7":
                return this.renderArticleTemplateSeven(article_data.article_id, article_data.template, article_data.heading, article_data.subheadings, article_data.texts, article_data.links, article_data.images);
            case "template-8":
                return this.renderArticleTemplateEight(article_data.article_id, article_data.template, article_data.heading, article_data.subheadings, article_data.texts, article_data.links, article_data.images);
            case "template-9":
                return this.renderArticleTemplateNine(article_data.article_id, article_data.template, article_data.heading, article_data.subheadings, article_data.texts, article_data.links, article_data.images);
            case "template-10":
                return this.renderArticleTemplateTen(article_data.article_id, article_data.template, article_data.heading, article_data.subheadings, article_data.texts, article_data.links, article_data.images);
            case "template-11":
                return this.renderArticleTemplateEleven(article_data.article_id, article_data.template, article_data.heading, article_data.subheadings, article_data.texts, article_data.links, article_data.images);
            default:
     ...
     * @returns 
     */
    renderArticleTemplateOne(id, template = "template-1", heading = "Heading Goes Here", texts = [['Enter text here']], links = [[]]) {
    ...
    renderArticleTemplateTwo(id, template = "template-2", heading = "Heading Goes Here", texts = [['Enter text here']], links = [[]], images = []) {
        let h1 = Util.tag('h1', {'class': 'article-title'}, heading);
    ...
    renderArticleTemplateThree(id, template = "template-3", heading = "Heading Goes Here", texts = [['Enter text here']], links = [[]], images = []) { 
        let h1 = Util.tag('h1', {'class': 'article-title'}, heading);
    ...
    renderArticleTemplateFour(id, template = "template-4", heading = "Heading Goes Here", subheadings = "Enter Secondary Heading", texts = [['Enter text here']], links = [[]], images = []) {
        let h1 = Util.tag('h1', {'class': 'article-title'}, heading);
    ...
    renderArticleTemplateFive(id, template = "template-5", heading = "Heading Goes Here", subheadings = "Enter Secondary Heading", texts = [['Enter text here']], links = [[]], images = []) {
        let h1 = Util.tag('h1', {'class': 'article-title'}, heading);
    ...
    renderArticleTemplateSix(id, template = "template-6", heading = "Heading Goes Here", subheadings = "Enter Secondary Heading", texts = [['Enter text here']], links = [[]], images = []) {
        let h1 = Util.tag('h1', {'class': 'article-title'}, heading);
    ...
    renderArticleTemplateSeven(id, template = "template-7", heading = "Heading Goes Here", subheadings = "Enter Secondary Heading", texts = [['Enter text here']], links = [[]], images = []) {
        let h1 = Util.tag('h1', {'class': 'article-title'}, heading);
    ...
    renderArticleTemplateEight(id, template = "template-8", heading = "Heading Goes Here", subheadings = "Enter Secondary Heading", texts = [['Enter text here']], links = [[]], images = []) {
        return this.renderArticleTemplateSix(id, template, heading, subheadings, texts, links, images);
    }


    renderArticleTemplateNine(id, template = "template-9", heading = "Heading Goes Here", subheadings = "Enter Secondary Heading", texts = [['Enter text here']], links = [[]], images = []) {
        return this.renderArticleTemplateSeven(id, template, heading, subheadings, texts, links, images);
    }


    renderArticleTemplateTen(id, template = "template-10", heading = "Heading Goes Here", subheadings = "Enter Secondary Heading", texts = [['Enter text here']], links = [[]], images = []) {
        let h1 = Util.tag('h1', {'class': 'article-title'}, heading);
    ...
    renderArticleTemplateEleven(id, template = "template-11", heading = "Heading Goes Here", subheadings = "Enter Secondary Heading", texts = [['Enter text here']], links = [[]], images = []) {
        let h1 = Util.tag('h1', {'class': 'article-title'}, heading);
